...
class INDDataset(Dataset):
    """Dataset class for loading individual posts from IND dataset."""
    ...
    def _load_events(self) -> Dict:
        """Load event data."""
        events_path = self.data_dir / 'processed' / 'ind' / 'events'
        if self.event_id:
    ...
    def _load_windows(self) -> Dict:
        """Load window data."""
        windows_path = self.data_dir / 'processed' / 'ind' / 'windows'
        if self.window_id:
    ...
    def _create_samples(self) -> List[Dict]:
        ...
        samples = []
        feature_paths = get_feature_paths(self.data_dir, self.split, 'ind')
...
class INDWindowDataset(Dataset):
    """Dataset class for loading entire windows from IND dataset."""
